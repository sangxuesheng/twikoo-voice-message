...
export default {
  ...
  [S.ACI + '_VOICE_MAX_DURATION']: [
    '语音录制最大时长（秒），默认为：60',
    '語音錄製最大時長（秒），預設為：60',
    '語言錄製最大時長（秒），預設為：60',
    'Maximum voice recording duration (seconds). Default: 60.',
    'Максимал овоз ёзиш вақти (сония). Стандарт: 60.',
    '音声録音の最大時間（秒）。デフォルト：60',
    '음성 녹음 최대 시간 (초). 기본값: 60.'
  ],
  [S.ACI + '_VOICE_CDN']: [
