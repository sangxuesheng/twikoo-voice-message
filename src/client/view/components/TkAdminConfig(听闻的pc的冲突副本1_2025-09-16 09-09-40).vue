      ...
      settings: [
        ...
        },
        {
          ...
          items: [
            ...
            { key: 'VOICE_MAX_DURATION', desc: t('ADMIN_CONFIG_ITEM_VOICE_MAX_DURATION'), ph: `${t('ADMIN_CONFIG_EXAMPLE')}60`, value: '' },
            ...
            { key: 'VOICE_CDN_DOMAIN', desc: t('ADMIN_CONFIG_ITEM_VOICE_CDN_DOMAIN'), ph: `${t('ADMIN_CONFIG_EXAMPLE')}cos.ap-nanjing.myqcloud.com`, value: '' },
            { key: 'VOICE_CDN_REGION', desc: t('ADMIN_CONFIG_ITEM_VOICE_CDN_REGION'), ph: `${t('ADMIN_CONFIG_EXAMPLE')}ap-shanghai`, value: '' },
            { key: 'VOICE_CDN_BUCKET', desc: t('ADMIN_CONFIG_ITEM_VOICE_CDN_BUCKET'), ph: `${t('ADMIN_CONFIG_EXAMPLE')}您的存储桶名称`, value: '' },
            { key: 'VOICE_CDN_PATH', desc: t('ADMIN_CONFIG_ITEM_VOICE_CDN_PATH'), ph: `${t('ADMIN_CONFIG_EXAMPLE')}/twikoo`, value: '' },
